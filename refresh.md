{IN TYPE ALONG MODE THE TEXT GETS OUTSIDE THE BOX, THAT IS AN ERROR, IT SHOULD BE FORMATED TO BE INSIDE THE BOX ALSO FOR FILL IN THE BLANK MODE SHOULD LOOK AS NICE AS THE TYPE ALONG UI ALSO FORMATTED AND THE SYNTAX LAB WORDS TO PRACTICE BAR HAS WORDS CALLED (target0) FIX THAT TO GET PROPER FEEDBACK ACCORDING THE WORDS TO REALLY PRACTICE}
