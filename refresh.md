{ 
OKAY WE NEED TO KEEP PUSHING YESTERDAY WE SOLVED THE PROGRESSION PROBLEM, NOW TODAY ALL WE GOTTA SOLVE IS THAT WHEN THE USER TYPES IN A WORD AND IT IS CORRECT IN FILL IN BLANK LAB IT NEEDS TO UPDATE THAT BLANK INTO THE EXISTING WORD THAT IS HAS BEEN EXECUTED UPON, FOR EXAMPLE IN JOHN 3:16, IF THE LAST 2 WORDS ARE IN THE FILL IN THE BLANK THEN WE NEED TO TYPE "ETERNAL" THEN THAT WORD SHOULD FILL IN THE BLANK WITH THE ACTUAL WORD, THEN PROCEED WITH THE NEXT BLANK (WHICH IT DOES ALREADY PROCEED TO THE NEXT BLANK SO THATS GOOD) JUST WORK ON HAVING THE UNDERLINED BLANK FILLED IN WHEN IT IS CORRECT
}
